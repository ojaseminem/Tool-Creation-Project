...
namespace Tools.ProceduralRecoilSystem
{
    public class ProceduralRecoilManager : MonoBehaviour
    {
        #region Variables
        ...
        //[SerializeField] private (script_name) (name)Script;
        ...
        private void Update()
        {
            //m_IsAiming = (name)Script.(aiming bool variable); 
